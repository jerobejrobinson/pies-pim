...
import { Search, Edit, AlertCircle, Package } from 'lucide-react'
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert"
import DashboardHeader from '@/components/DashboardHeader'

export default function PartsWithoutPackages() {
  ...
  return (
    <>
    <DashboardHeader title={'Packages Dashboard'}/>
    <div className="container mx-auto px-4 py-8 max-w-7xl sm:px-6 lg:px-8">
      <h2 className="text-2xl font-bold mb-4">Search For Part Numbers Without Packages</h2>
            ...
            <Table>
              ...
              <TableBody>
                {parts.length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={4} className="text-center">No parts without packages found</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
