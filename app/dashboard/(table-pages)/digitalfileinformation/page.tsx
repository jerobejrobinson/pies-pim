...
import { Search, Edit, AlertCircle, Image } from 'lucide-react'
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert"
import CardCount from '@/components/CardCount'
import DashboardHeader from '@/components/DashboardHeader'

export default function PartsWithoutDigitalAssets() {
  ...
  const fetchParts = async () => {
    ...
    try {
      let query = supabase
        .from('parts')
        .select('*, digitalfileinformation(*)', { count: 'exact' })
        .is('digitalfileinformation', null)
  ...
  return (
    <>
    <DashboardHeader title={'Digital Assets Dashboard'}/>
    <div className="container mx-auto px-4 py-8 max-w-7xl sm:px-6 lg:px-8">
      <h2 className="text-2xl font-bold mb-4">Search For Part Numbers Without Digital Assets</h2>
            ...
            <Table>
              ...
              <TableBody>
                {parts.length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={4} className="text-center">No parts without digital assets found</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
