...
import { Search, Edit, AlertCircle, Repeat } from 'lucide-react'
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert"
import DashboardHeader from '@/components/DashboardHeader'

export default function PartsWithoutInterchanges() {
  ...
  const fetchParts = async () => {
    ...
    try {
      let query = supabase
        .from('parts')
        .select('*, partinterchange(*)', { count: 'exact' })
        .is('partinterchange', null)
  ...
  return (
    <>
    <DashboardHeader title={'Interchanges Dashboard'}/>
    <div className="container mx-auto px-4 py-8 max-w-7xl sm:px-6 lg:px-8">
      <h2 className="text-2xl font-bold mb-4">Search For Part Numbers Without Interchanges</h2>
            ...
            <Table>
              ...
              <TableBody>
                {parts.length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={4} className="text-center">No parts without interchanges found</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
